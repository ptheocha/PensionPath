  ...
  return(
    <span style={{position:"relative",display:"inline-flex",alignItems:"center",marginLeft:6}}>
      <span
        ...
        style={{
          width:16,height:16,borderRadius:"50%",background:"#403e3a",border:"1px solid #524f44",
          display:"inline-flex",alignItems:"center",justifyContent:"center",
          fontSize:10,fontWeight:700,color:"#858070",cursor:"pointer",
      ...
      {show&&<>
        ...
        <div style={{
          ...
          background:"#403e3a",border:"1px solid #524f44",borderRadius:8,padding:"10px 14px",
          fontSize:12,color:"#c4b99a",fontFamily:"'DM Sans',sans-serif",lineHeight:1.5,
          width:240,maxWidth:"calc(100vw - 48px)",zIndex:1000,boxShadow:"0 8px 24px rgba(0,0,0,0.5)",
...
function Input({label,value,onChange,prefix,tooltip}){
  ...
  return(
    <div style={{flex:"1 1 200px",minWidth:0,marginBottom:4}}>
      <label style={{display:"flex",alignItems:"center",fontSize:12,fontWeight:600,color:"#c4b99a",marginBottom:6,fontFamily:"'DM Sans',sans-serif",letterSpacing:"0.01em"}}>
        {label}
          ...
          {showAdvanced&&(
            <div style={{padding:24,background:"#38362e",borderRadius:12,border:"1px solid #403e3a"}}>
              <div style={{marginBottom:24}}>
                ...
                <input type="range" min={4} max={10} step={0.5} value={investReturn} onChange={e=>setInvestReturn(parseFloat(e.target.value))} style={{width:"100%",accentColor:"#d4a843"}}/>
              ...
              <div style={{marginBottom:24}}>
                ...
                <input type="range" min={0} max={4} step={0.25} value={colaRate} onChange={e=>setColaRate(parseFloat(e.target.value))} style={{width:"100%",accentColor:"#d4a843"}}/>
              ...
              <div>
                ...
                <input type="range" min={70} max={100} step={1} value={lifeExp} onChange={e=>setLifeExp(parseInt(e.target.value))} style={{width:"100%",accentColor:"#d4a843"}}/>
            ...
            {!emailSent?(
              <div style={{background:"linear-gradient(135deg,#3e3828,#302f29)",border:"1px solid #d4a84333",borderRadius:14,padding:"32px 24px",marginBottom:28,textAlign:"center"}}>
                ...
                <div style={{display:"flex",gap:10,maxWidth:440,margin:"0 auto",flexWrap:"wrap"}}>
                  ...
                  <button onClick={()=>{if(email.includes("@"))setEmailSent(true)}} style={{
